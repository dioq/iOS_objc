...
static GPBFileDescription PersonRoot_FileDescription = {
  .package = NULL,
  .prefix = NULL,
...
+ (GPBDescriptor *)descriptor {
  ...
  if (!descriptor) {
    ...
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:GPBObjCClass(Person)
                                   messageName:@"Person"
                               fileDescription:&PersonRoot_FileDescription
                                        fields:fields
